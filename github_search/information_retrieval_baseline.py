...
__all__ = ['get_task_grouped_titles', 'RetrievalDataset', 'get_information_retrieval_metrics',
...
def get_task_grouped_titles(papers_with_repo_df):
    papers_df = papers_with_repo_df[["title", "tasks"]]
...
def get_query_results_df(evaluator, model, queries):
    query_results = evaluator.get_queries_result_list(glove_model, queries)['cos_sim']
    return pd.DataFrame({
