...
__all__ = ['make_vizualization_df', 'default_dimensionality_reducer', 'reference_modules', 'show_scatterplot']
...
def make_vizualization_df(keyed_vectors, dimensionality_reducer=default_dimensionality_reducer):
