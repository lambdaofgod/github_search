...
class EmbedderFactory:
    ...
    def make_from_train_val_config(
        ...
        query_config = get_data_config(train_val_config.query_embedder, encoding_fn, 100, query_tokenizer)
        document_config = get_data_config(train_val_config.document_embedder, encoding_fn, max_length, document_tokenizer)
    ...
    def get_nbow_embedder(
            self, config, target_dim: Optional[int]
    ):
