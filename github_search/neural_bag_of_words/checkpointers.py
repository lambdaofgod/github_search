...
from github_search.neural_bag_of_words import embedders, evaluation, model_utils
...
class EncoderCheckpointer:
    ...
    def get_metrics_df(self, nbow_pair, epoch):
        ...
        metrics_dict = self.get_epoch_metrics_from_embedders(embedder_pair)
